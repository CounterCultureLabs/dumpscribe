...
parser = argparse.ArgumentParser(
    ...
    usage="convert_and_organize.py [-h] [--aac] [--thumb] input_dir output_dir",
    epilog="input_dir is the directory generated by dumpscribe.\noutput_dir is where to write the output from this program."
)
